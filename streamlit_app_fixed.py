...
def create_business_impact_chart():
    ...
    # Cost per readmission (realistic estimate based on healthcare industry)
    cost_per_readmission = 3000  # $3,000 average cost per readmission
...
def show_business_impact_page():
    ...
    prevented_readmissions = int(current_readmissions * reduction_rate)
    cost_per_readmission = 3000  # $3,000 realistic cost per readmission
    annual_savings = prevented_readmissions * cost_per_readmission
